                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-striped table-bordered table-sm small nowrap" style="width: 100%" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$machines->id}}</td>
                                    <td>{{$machines->machine}}</td>
                                    <td>{{$machines->description}}</td>
                                    <td class="text-right">
                                            <button name="edit" id="{{$machines->id}}" class="edit btn btn-outline-primary btn-sm" type="submit"><i class="fas fa-pencil-alt"></i></button>
                                            <button type="submit" name="delete" id="{{$machines->id}}" class="delete btn btn-outline-danger btn-sm"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
