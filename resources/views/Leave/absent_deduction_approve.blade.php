        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header p-2">
                    <h5 class="modal-title" id="staticBackdropLabel">Approve Absent Deduction </h5>
...
<script>
    $(document).ready(function () {
        ...
        $('#formFilter').on('submit', function (event) {
            ...
            var action_url = "{{ route('absentdeductioncreate') }}";
                    ...
                    $('#dataTable tbody .selectCheck:checked').each(function () {
                        ...
                        if (rowData) {
                            selectedRowIdsapprove.push({
                                ...
                                attendance_percentage: rowData[4], 
                                deduction_amount: rowData[5], 
        ...
        $('#approve_button').click(function () {
            ...
            $.ajax({
                url: '{!! route("absentdeductionapprove") !!}',
                type: 'POST',
                dataType: "json",
                data: {
