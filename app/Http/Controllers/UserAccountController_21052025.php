...
class UserAccountController extends Controller
{
    public function useraccountsummery_list()
    {
        ...
        return view('UserAccountSummery.useraccountsummery',compact('emprecordid','emp_id','emp_location','employee','leavetype','emp_name_with_initial','calling_name','payment_period'));
    }
